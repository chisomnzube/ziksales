...
//if (isset($_POST['button'])) {
    ...
    $sendername = substr('Ziksales', 0, 11);
    $recipients = '7031382795';
    $message = 'Dear Chisom, '.$paymentDetails['data']['metadata']['name'].' ordered for an item on ziksales. his number is '.$paymentDetails['data']['metadata']['phone'].' login @ www.ziksales.com';
    $flash = 0;
